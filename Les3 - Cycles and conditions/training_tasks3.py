...
# с клавиатуры. Программа должна вывести количество гласных и согласных букв во введенной
# строке.
import sys
...
for i in range(1, num+1):
    res += i
print(f"Сумма всех чисел по способу 2 = {res}")
...
while num !=0:
    res += num
    num -= 1
print(f"Сумма всех чисел по способу 3 = {res}")
